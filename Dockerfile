...
#RUN apt-get install -y imagemagick poppler-utils tesseract-ocr-all default-jre unzip ghostscript
# Update ImageMagick configuration file to allow PDFs
#RUN sed 's/rights="none" pattern="PDF"/rights="read" pattern="PDF"/' /etc/ImageMagick-6/policy.xml >/etc/ImageMagick-6/policy.xml
